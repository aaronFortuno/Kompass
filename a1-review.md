...
- **Estructural:**
  - [MITJA] [A1b-9] Flux temàtic abrupte (A1b-1..4 geografia → A1b-5..8 preferències → A1b-9 imperatiu). Revisar coherència seqüencial global.

### A1b-10 · Verben -ieren

- **Estructural:**
  - [BAIXA] [A1b-10] Ubicació sense lògica clara (bonus lèxic transparent). Moure'l cap A1b-1/2 (bonus de preposicions) o cap A1b-27 (on la regla del participi sense _ge-_ és crucial).
